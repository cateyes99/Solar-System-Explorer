...
When you give this to **OpenCode**, I'd add one final instruction outside the prompt:
...
That is particularly useful with an agentic coding tool.

Also, I'd **specifically encourage it to use React Three Fiber rather than asking it to choose arbitrary 3D technology**. R3F is designed to make Three.js scenes reusable React components, which fits the architecture above very well.  GitHub+1

If you want, I can also create a **much more ambitious "NASA Mission Control / Space Explorer" version of this prompt**—with wormholes, spacecraft missions, planet landing sequences, interactive Moon/Mars surfaces, black holes, asteroid mining, and a proper **Kids Space Academy** game layer.